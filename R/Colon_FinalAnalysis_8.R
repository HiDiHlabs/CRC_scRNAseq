...
columnIdx <- c(7,6,3,4,2)
par(mfrow = c(1,5))
for (c in 1:5){
  hist(GeneSetScores[,c],
       main = paste("Histogram of" , FactorNames[c]))
}
...
# load GeneSetScores of merged factors, and of top genes of merged factors
# load("D:/Teresa/Colon-final/FactorScoring/GeneSetScores_mergedFactors.Rdata")
load("D:/Teresa/Colon-final/FactorScoring/GeneSetScores_topGenesFromMergedFactors.Rdata")
# GeneSetScores_mergedFactors <- t(CellScoresMatrix)
# rownames(GeneSetScores_mergedFactors) <- rownames(GeneSetScores)
# GeneSetScores_topGenesFromMergedFactors <- GeneSetScores
# rm(CellScoresMatrix)
# rm(GeneSetScores)
# GeneSetScores <- GeneSetScores_mergedFactors
...
pdf(sprintf("D:/Teresa/Colon-final/OXPHOS_in_DCS_vs_STEM_new/%s/Factor_OXPHOS_inDCSvsSTEM.pdf",writefolder),width=7,height=5,paper='special') 
...
pdf(sprintf("D:/Teresa/Colon-final/OXPHOS_in_DCS_vs_STEM_new/%s/Factor_HypoxGlycol_inDCSvsSTEM.pdf",writefolder),width=7,height=5,paper='special') 
...
pdf(sprintf("D:/Teresa/Colon-final/OXPHOS_in_DCS_vs_STEM_new/%s/Factor_OXPHOS_inDCSvsSTEM_exclQuenched.pdf",writefolder),width=6,height=5,paper='special') 
...
pdf(sprintf("D:/Teresa/Colon-final/OXPHOS_in_DCS_vs_STEM_new/%s/Factor_HypoxGlycol_inDCSvsSTEM_exclQuenched.pdf",writefolder),width=6,height=5,paper='special') 
...
write.csv(pvalues_OXPHOS, file = sprintf("D:/Teresa/Colon-final/OXPHOS_in_DCS_vs_STEM_new/%s/pvalues_OXPHOS.csv",writefolder))
write.csv(pvalues_Hypox, file = sprintf("D:/Teresa/Colon-final/OXPHOS_in_DCS_vs_STEM_new/%s/pvalues_Hypox.csv",writefolder))
...
write.csv(pvalues_ctrl_OXPHOS, file = sprintf("D:/Teresa/Colon-final/OXPHOS_in_DCS_vs_STEM_new/%s/pvalues_ctrl_OXPHOS.csv",writefolder))
write.csv(pvalues_ctrl_Hypox, file = sprintf("D:/Teresa/Colon-final/OXPHOS_in_DCS_vs_STEM_new/%s/pvalues_ctrl_Hypox.csv",writefolder))
